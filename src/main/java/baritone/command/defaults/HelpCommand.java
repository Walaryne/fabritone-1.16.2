        ...
        if (!args.hasAny() || args.is(Integer.class)) {
            Paginator.paginate(
                    ...
                    command -> {
                        ...
                        MutableText component = new LiteralText(name);
            ...
            logDirect("");
            MutableText returnComponent = new LiteralText("Click to return to the help menu");
