...
public class WaypointsCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        BiFunction<IWaypoint, Action, Text> toComponent = (waypoint, _action) -> {
            ...
            MutableText tagComponent = new LiteralText(waypoint.getTag().name() + " ");
            tagComponent.setStyle(tagComponent.getStyle().withFormatting(Formatting.GRAY));
            String name = waypoint.getName();
            MutableText nameComponent = new LiteralText(!name.isEmpty() ? name : "<empty>");
            nameComponent.setStyle(nameComponent.getStyle().withFormatting(!name.isEmpty() ? Formatting.GRAY : Formatting.DARK_GRAY));
            MutableText timestamp = new LiteralText(" @ " + new Date(waypoint.getCreationTimestamp()));
        ...
        if (action == Action.LIST) {
            ...
            MutableText component = new LiteralText("Waypoint added: ");
            ...
            if (waypoint == null) {
                ...
                if (action == Action.INFO) {
                    ...
                    MutableText deleteComponent = new LiteralText("Click to delete this waypoint");
                    ...
                    MutableText goalComponent = new LiteralText("Click to set goal to this waypoint");
                    ...
                    MutableText backComponent = new LiteralText("Click to return to the waypoints list");
