    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (paginate) {
            ...
            Paginator.paginate(
                    ...
                    setting -> {
                        MutableText typeComponent = new LiteralText(String.format(
                                " (%s)",
                        ...
                        MutableText component = new LiteralText(setting.getName());
        ...
        if (!doingSomething && !args.hasAny()) {
            ...
            MutableText oldValueComponent = new LiteralText(String.format("Old value: %s", oldValue));
